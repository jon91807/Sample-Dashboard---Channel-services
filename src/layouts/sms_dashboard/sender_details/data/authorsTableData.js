...
const authorsTableData = {
  ...
  rows: [
    {
      Sender_Code: <Author image={img2} name="TX-YRPXE" />,
    ...
    {
      Sender_Code: <Author image={img1} name="PROMO-NIRMA" />,
      Type: <Function job="Promotional" />,
      status: (
    ...
    {
      Sender_Code: <Author image={img3} name="TX-ICICILOAN" />,
      Type: <Function job="Transactional" />,
      status: (
    ...
    {
      Sender_Code: <Author image={img1} name="PROMO-OYOHOMES" />,
      Type: <Function job="Promotional" />,
      status: (
        <SoftBadge variant="gradient" badgeContent="Active" color="success" size="xs" container />
      ),
    ...
    {
      Sender_Code: <Author image={img2} name="TX-KAJARIYA" />,
      Type: <Function job="Transactional" />,
      status: (
        <SoftBadge variant="gradient" badgeContent="Active" color="success" size="xs" container />
      ),
